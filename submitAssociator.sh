...
cp output_gsf_associator.root /afs/cern.ch/work/c/cbernkop/condor_output/assoc_output_new/output_gsf_associator.root
echo "3 complete: cp output_gsf_associator.root"
cp step3.root /afs/cern.ch/work/c/cbernkop/condor_output/assoc_output_new/step3.root
